...
<h3></h3>
<h3>MODIFICA VALORE TECNICO</h3>

<form action="" method="POST" name="valorimag">

<?php
$id = $_GET['id'];
$q = $x->query('SELECT * FROM tecnico WHERE id='.$id.'');
$d = $q->fetch_array();
?>

<input type="text" name="tecnico" id="tecnico" value="<?php echo $d['nome'];?>" required>
<input type="submit" name="tecedit" value="MODIFICA">
...
<h3 style="text-align:center;"><img src="./AntiCopy.png" width="16" height="16"> 2018 Gestione Magazzino by Fabrizio Amorell e Giulia Sedda</h3>
...
if(isset($_POST['tecedit'])){
	$tecnico = $_POST['tecnico'];
	$q = $x->query('UPDATE tecnico SET nome="'.$tecnico.'" WHERE id="'.$id.'"');
