...
function refresh_table(){
	...
	if(document.getElementById("n_pag") != null){
		...
		$("#scar").load('script/scarico.php?x_pag='+x_pag+'&pag='+n_pag+'&years='+y+'&da='+da+'&bene='+bene+'&tec='+tec);
		changebene();
...
function exp(){
	...
	if(document.getElementById("n_pag") != null){
		...
		location.href='script/export.php?id=2&x_pag='+x_pag+'&pag='+n_pag+'&years='+y+'&da='+da+'&bene='+bene+'&tec='+tec
	}
